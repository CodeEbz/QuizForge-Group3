...
const subjects = [
  ...
  { name: "React",           icon: "⚛",  color: "var(--cyan)",   bg: "var(--cyan-bg)",   border: "var(--cyan-border)",   darkIcon: "#67e8f9", lightIcon: "#0e7490" },
  ...
  { name: "C++",             icon: "⚙",  color: "var(--purple)", bg: "var(--purple-bg)", border: "var(--purple-border)", darkIcon: "#d8b4fe", lightIcon: "#6b21a8" },
  { name: "C#",              icon: "♯",  color: "var(--purple)", bg: "var(--purple-bg)", border: "var(--purple-border)", darkIcon: "#d8b4fe", lightIcon: "#6b21a8" },
  { name: "SQL",             icon: "🗄",  color: "var(--cyan)",   bg: "var(--cyan-bg)",   border: "var(--cyan-border)",   darkIcon: "#67e8f9", lightIcon: "#0e7490" },
    ...
    <div className="quiz-menu-page">
      ...
      <main className="quiz-menu-main">
        ...
        <div className="subjects-grid">
          {subjects.map(sub => {
            // Subjects with darkIcon/lightIcon have theme-specific icon colors
            // (previously hardcoded white, which is invisible on dark and illegible on light)
            let iconColor = sub.color
            if (sub.darkIcon || sub.lightIcon) {
              iconColor = isLight
                ? (sub.lightIcon || sub.color)
                : (sub.darkIcon  || sub.color)
            }
            ...
            return (
              ...
              >
                <span className="subject-icon" style={{ color: iconColor }}>{sub.icon}</span>
