...
const subjects = [
  ...
  { name: "React", icon: "⚛", color: "var(--cyan)", bg: "var(--cyan-bg)", border: "var(--cyan-border)" },
  ...
  { name: "C++", icon: "⚙", color: "var(--purple)", bg: "var(--purple-bg)", border: "var(--purple-border)" },
  { name: "C#", icon: "♯", color: "var(--purple)", bg: "var(--purple-bg)", border: "var(--purple-border)" },
  { name: "SQL", icon: "🗄", color: "var(--cyan)", bg: "var(--cyan-bg)", border: "var(--cyan-border)" },
  ...
  return (
    <div className="quiz-menu-page">
      ...
      <main className="quiz-menu-main">
        <h1 className="quiz-menu-title">
          Choose a Subject
        </h1>

        <p className="quiz-menu-sub">
          15 subjects available · Select one to start your quiz
        </p>
        ...
        <div className="subjects-grid">
          {subjects.map((subject) => (
            <button
              ...
              onClick={() =>
                navigate(`/difficulty/${slugify(subject.name)}`)
              }
            >
